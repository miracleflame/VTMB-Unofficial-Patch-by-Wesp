...
REG>nul ADD "HKCU\Software\Classes\TTZFile\shell\Conv2Vtf" /f /ve         /d "Convert to .vtf..."
REG>nul ADD "HKCU\Software\Classes\TTZFile\shell\Conv2Vtf\command" /f /ve /d "%CD%\TexConvert.exe \"%%1\" -tovtf"
REG>nul ADD "HKCU\Software\Classes\TTZFile\shell\Expt2Img" /f /ve         /d "Convert to .%ExportFormat%..."
REG>nul ADD "HKCU\Software\Classes\TTZFile\shell\Expt2Img\command" /f /ve /d "%CD%\TexConvert.exe \"%%1\" -toimg"
